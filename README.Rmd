...
This package contains a collection of datasets about the Colombian Constitutional Court collected with the help of Large Language Models. It is meant to complement the datasets collected in the ccc package.
...
```{r court-cohorts, message=FALSE, fig.height = 6, fig.width = 7}
library(tidyverse)
