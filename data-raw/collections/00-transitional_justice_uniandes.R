...
d <- read_rds("data-raw/collections/fichas.rds")
pg <- read_rds("data-raw/collections/perspectiva_global.rds")
dict <- read_rds("data-raw/collections/dict_tema_eje_palabra.rds")
